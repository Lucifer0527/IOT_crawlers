//Code for shopping automation using RFID sensers - Ashwajeet Prasad
...
char pnm  [no_ims][50] = {"Product_1", "Product_2", "Product_3"}; //Product name
int  price[no_ims] = {100,200,300}, price_sum = 0, j = 0;
